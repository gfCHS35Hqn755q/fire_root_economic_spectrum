...
SRL_functional_groups <- ggplot(data = data_combined, aes(x = functional_group, y = SRL)) +
  geom_boxplot(aes(fill = functional_group)) +
  ylab("SRL") +
  xlab("Functional Group") +
  scale_fill_manual(values = c("#386cb0", "#fdb462","#7fc97f")) +
...
diam_functional_groups <- ggplot(data = data_combined, aes(x = functional_group, y = average_diameter_mm)) +
  geom_boxplot(aes(fill = functional_group)) +
